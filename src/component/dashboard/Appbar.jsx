...
import {MdBrightness4, MdBrightness7, MdMenu, MdSearch, MdSettings, MdSunny} from "react-icons/md";
        ...
        <Box sx={{ flexGrow: 1 }}>
            <AppBar position="static"  elevation={0} sx={{
                ...
                <Toolbar sx={{
                    ...
                    <IconBar>
                        <Box display={"flex"} justifyContent={"space-between"} alignItems={"center"} mx={2} width={100}>
                            <IconButton
                                size="medium"
                                edge="start"
                                color="action.active"
